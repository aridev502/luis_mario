    ...
    <div class="container">
        ...
        <form action="{{ route('admin.duenos.update', $dueno->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="direccion" id="direccion" class="form-control" value="{{ $dueno->direccion }}"
                    required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="dpi" id="dpi" class="form-control" value="{{ $dueno->dpi }}"
                    required>
            </div>

            <div class="form-group">
                <label for="ubicacion">Ubicación:</label>
                <input type="text" name="ubicacion" id="ubicacion" class="form-control" value="{{ $dueno->ubicacion }}"
                    required>
            </div>

            <div class="form-group">
                <label for="tipo">Tipo:</label>
                <input type="text" name="tipo" id="tipo" class="form-control" value="{{ $dueno->tipo }}"
                    required>
            </div>

            <div class="form-group">
                <label for="aux1">Aux 1:</label>
                <input type="text" name="aux1" id="aux1" class="form-control" value="{{ $dueno->aux1 }}">
            </div>

            <div class="form-group">
                <label for="aux2">Aux 2:</label>
                <input type="text" name="aux2" id="aux2" class="form-control" value="{{ $dueno->aux2 }}">
            </div>
